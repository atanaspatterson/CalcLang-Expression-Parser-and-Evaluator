...
#define SCAN_TOKEN_STRINGS {"TK_INTLIT", "TK_BINLIT", "TK_HEXLIT", \
                            "TK_LPAREN", "TK_RPAREN", \
                            "TK_PLUS", "TK_MINUS", "TK_MULT", "TK_DIV", "TK_AND", "TK_OR", "TK_XOR", "TK_NOT", "TK_RSHIFT", "TK_LSHIFT"\
                            "TK_EOT", "TK_ANY"};
...
enum parse_oper_enum {OP_PLUS, OP_MINUS, OP_MULT, OP_DIV, OP_AND, OP_OR, OP_XOR, OP_NOT, OP_RSHIFT, OP_LSHIFT};
